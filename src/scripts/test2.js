    ...
    depthChart = new Highcharts.chart({
        ...
        tooltip: {
            ...
            pointFormatter: function(arg1, arg2) {
                ...
                console.log(arg1);
                var string =
                    '<div class="f_h" style="color: #a2afbe;">' + parseFloat(this.x.toFixed(8)) + ' USD</div>' +
                    '<div class="t_i" style="color: #a2afbe;">' +
                    '<div class="f_t_i"><div class="t_h">' + fti + ':</div><div class="t_v" style="color: #545c6d;">' + parseFloat(this.y.toFixed(8)) + '</div></div>' +
                    '<div><div class="t_h">For a total of:</div><div class="t_v" style="color: #545c6d;">' + Highcharts.numberFormat(parseFloat(this.x.toFixed(8)) * this.y, 2) + ' USD</div></div>' +
                    '</div>';
                return string;
            },
            style: {
